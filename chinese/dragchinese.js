...
function mergePiano(){
    ...
    console.log(r);
    //var myAudio = document.getElementById(o+ "Audio");
    var playlistP = new Array('./musicp/Chinese/'+o+'.wav','./musicp/Chinese/'+p+'.wav','./musicp/Chinese/'+q+'.wav','./musicp/Chinese/'+r+'.wav');
...
function mergePiano1(){
    ...
    let PlaylistPString = playlistP.toString();
    console.log(PlaylistPString); //轉字串
    if (PlaylistPString.includes('./musicp/Chinese/e.wav,./musicp/Chinese/a.wav')){
